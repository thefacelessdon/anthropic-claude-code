...
DO $$ BEGIN CREATE TYPE investment_category AS ENUM (
...
DO $$ BEGIN CREATE TYPE compounding_status AS ENUM (
  'compounding',
  'not_compounding',
  'too_early',
  'unknown'
...
DO $$ BEGIN CREATE TYPE narrative_source_type AS ENUM (
  'institutional',
...
DO $$ BEGIN CREATE TYPE gap_level AS ENUM (
  'high',
  'medium',
  'low',
  'aligned'
...
DO $$ BEGIN CREATE TYPE output_type AS ENUM (
  'directional_brief',
...
CREATE INDEX IF NOT EXISTS idx_orgs_ecosystem ON organizations(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_orgs_type ON organizations(org_type);
CREATE INDEX IF NOT EXISTS idx_contacts_org ON contacts(organization_id);
CREATE INDEX IF NOT EXISTS idx_practitioners_ecosystem ON practitioners(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_investments_ecosystem ON investments(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_investments_source ON investments(source_org_id);
CREATE INDEX IF NOT EXISTS idx_investments_status ON investments(status);
CREATE INDEX IF NOT EXISTS idx_investments_category ON investments(category);
CREATE INDEX IF NOT EXISTS idx_decisions_ecosystem ON decisions(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_decisions_status ON decisions(status);
CREATE INDEX IF NOT EXISTS idx_decisions_locks ON decisions(locks_date);
CREATE INDEX IF NOT EXISTS idx_precedents_ecosystem ON precedents(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_opportunities_ecosystem ON opportunities(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_opportunities_status ON opportunities(status);
CREATE INDEX IF NOT EXISTS idx_opportunities_deadline ON opportunities(deadline);
CREATE INDEX IF NOT EXISTS idx_opportunities_type ON opportunities(opportunity_type);
CREATE INDEX IF NOT EXISTS idx_narratives_ecosystem ON narratives(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_narratives_gap ON narratives(gap);
CREATE INDEX IF NOT EXISTS idx_outputs_ecosystem ON outputs(ecosystem_id);
CREATE INDEX IF NOT EXISTS idx_outputs_type ON outputs(output_type);
CREATE INDEX IF NOT EXISTS idx_submissions_status ON submissions(status);
CREATE INDEX IF NOT EXISTS idx_activity_ecosystem ON activity_log(ecosystem_id);
...
CREATE OR REPLACE VIEW upcoming_interventions AS
  SELECT
    d.*,
...
DROP POLICY IF EXISTS "Published outputs are publicly readable" ON outputs;
...
DROP POLICY IF EXISTS "Authenticated read all" ON organizations;
CREATE POLICY "Authenticated read all"
  ON organizations FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read investments" ON investments;
...
DROP POLICY IF EXISTS "Authenticated read precedents" ON precedents;
CREATE POLICY "Authenticated read precedents"
  ON precedents FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read all opportunities" ON opportunities;
CREATE POLICY "Authenticated read all opportunities"
  ON opportunities FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read narratives" ON narratives;
CREATE POLICY "Authenticated read narratives"
  ON narratives FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read outputs" ON outputs;
...
DROP POLICY IF EXISTS "Authenticated read relationships" ON org_relationships;
CREATE POLICY "Authenticated read relationships"
  ON org_relationships FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read practitioners" ON practitioners;
CREATE POLICY "Authenticated read practitioners"
  ON practitioners FOR SELECT TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Authenticated read ecosystems" ON ecosystems;
